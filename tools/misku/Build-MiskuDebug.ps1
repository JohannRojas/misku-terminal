...
if (-not $tools.MSBuild) {
    throw 'MSBuild.exe was not found. Install Visual Studio 2022 with C++ desktop and Windows App SDK workloads.'
}
...
Write-Host "Building Misku Terminal $Configuration $Platform..."
