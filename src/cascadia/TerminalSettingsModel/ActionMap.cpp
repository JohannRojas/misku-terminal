    ...
    winrt::hstring ActionArgFactory::GetNameForAction(Model::ShortcutAction action, Windows::ApplicationModel::Resources::Core::ResourceContext context)
    {
        ...
        static auto actionNames = []() {
            return std::unordered_map<ShortcutAction, wil::zwstring_view>{
                ...
                { ShortcutAction::CloseSession, USES_RESOURCE(L"CloseSessionCommandKey") },
                ...
                { ShortcutAction::CreateSession, USES_RESOURCE(L"CreateSessionCommandKey") },
                ...
                { ShortcutAction::NextSession, USES_RESOURCE(L"NextSessionCommandKey") },
                ...
                { ShortcutAction::PrevSession, USES_RESOURCE(L"PrevSessionCommandKey") },
                ...
                { ShortcutAction::ReloadSettings, USES_RESOURCE(L"ReloadSettingsCommandKey") },
                { ShortcutAction::ToggleSessionSidebar, USES_RESOURCE(L"ToggleSessionSidebarCommandKey") },
