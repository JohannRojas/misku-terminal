...
namespace winrt::TerminalApp::implementation
{
    ...
    void TerminalPage::_InitializeTab(winrt::com_ptr<Tab> newTabImpl, uint32_t insertPosition)
    {
        ...
        // vertical tab list is visible. For tabs created after startup, make
        // the selected tab visible immediately instead of depending solely on
        // the collapsed TabView's SelectionChanged event.
